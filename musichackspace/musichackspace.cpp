...
musichackspace::musichackspace(const InstanceInfo& info)
...
#if IPLUG_DSP
void musichackspace::ProcessBlock(sample** inputs, sample** outputs, int nFrames)
{
...
void musichackspace::ProcessMidiMsg(const IMidiMsg& msg)
{
  mSynth.AddMidiMsgToQueue(msg);
}

void musichackspace::OnReset()
{
  mSynth.SetSampleRateAndBlockSize(GetSampleRate(), GetBlockSize());
}

void musichackspace::OnParamChange(int paramIdx)
{
