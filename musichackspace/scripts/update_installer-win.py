...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=musichackspace Demo Installer\n"
      else:
        line="OutputBaseFilename=musichackspace Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the musichackspace Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the musichackspace installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=musichackspace Demo installer\n"
     else:
       line="SetupWindowTitle=musichackspace installer\n"
