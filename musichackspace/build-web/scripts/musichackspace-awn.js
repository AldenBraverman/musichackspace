/* Declares the musichackspace Audio Worklet Node */

class musichackspaceController extends WAMController
{
  constructor (actx, options) {
    ...
    super(actx, "musichackspace", options);
  }
  ...
  static importScripts (actx) {
    ...
    return new Promise( (resolve) => {
      actx.audioWorklet.addModule(origin + "scripts/musichackspace-wam.js").then(() => {
      actx.audioWorklet.addModule(origin + "scripts/wam-processor.js").then(() => {
      actx.audioWorklet.addModule(origin + "scripts/musichackspace-awp.js").then(() => {
        resolve();
      }) }) });
    })
  }
